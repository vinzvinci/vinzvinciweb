...
export default function Speaking() {
  return (
    <>
      <Head>
        <title>jiraphinya Wechabut | Events</title>
        <meta
          name="description"
        ...
        <div className="space-y-20">
          <SpeakingSection title="2022 Highlights">
            <Appearance
              ...
              description="Samsung R&D Thailand invites me to Samsung Open Source Conference Thailand with the theme Bukás Para sa Bukas to be held online on 26th November 2022. It is a conference aiming to increase awareness on and appreciate for open source software in the Thailand."
              event="Samsung Open Source Conference Thailand"
              cta="Link"
            />
            <Appearance
              href="https://fb.watch/hGdDFjT0uO/"
              title="Head & Organizer of GitHub Field Day Thailand"
              description="I bring the unconference event for leaders of technical student communities in the Thailand. GitHub Field Day Thailand brings together a group of student leaders for a day of conversation in the form of lightning talks, discussions, games, or whatever suits the topic best."
              event="GitHub Field Day Thailand"
              cta="Watch video"
            />
            <Appearance
              href="#"
          ...
          <Appearance
            ...
            <Appearance
              href="#"
              title="Hacktoberfest Thailand 2021"
              description=""
